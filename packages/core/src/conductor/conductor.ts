...
import { DEFAULT_SKILLS_DIR_NAME, resolveSkillsDir } from '../skills.js';
...
export class Conductor implements IConductor {
   ...
   * `configSkillsDir` once at config resolution. This delegates to the single
   * exported `resolveSkillsDir` precedence implementation so the conductor and
   * any other caller share one source of truth.
   */
