...
export type ConcertEvent =
  ...
  | { type: 'movement:started'; concertId: ConcertID; movementId: MovementID; prompt?: string; timestamp: Date }
  ...
  | { type: 'movement:rejected'; concertId: ConcertID; movementId: MovementID; result: import('./concert.js').MovementRecord; retryCount: number; timestamp: Date }
